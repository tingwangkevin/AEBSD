...
positive0=function(r,rt,ppv,a,tau,lam1c,lam1e,lam0c,lam0e,precision=0.0001,alpha,power0,N0=0){
  ...
  while(pow<power0){
    ...
    pow=cibpower(tref,N*r,N*(1-r),mc[1],mc[2],red[1],red[2],accrual,tau,
                 alpha,pr=FALSE)
  }
  N1=N
